...
(function () {
    ...
    var Backup = function () {
        ...
        var processDetails = modalBody.querySelector('#process-info .process-details textarea');
        ...
        var renderLogs = function (logs, element) {
            ...
            logs.map(function (log, index) {
                ...
                logsHTML += "<li class=\"logs-list-item item-key-" + index + " notice notice-" + logType + "\">" + message + "</li>";
            });
            logsHTML += "</ul>";
        ...
        var removeProcStatFile = function () {
            ...
            navigator.sendBeacon(ajaxUrl + "?action=everest_backup_process_status_unlink&everest_backup_ajax_nonce=" + _nonce);
        };
        var lastHash = 0;
        /** @since 2.0.0 */
        var triggerSendBecon = function (data) {
             ...
             * @since 1.0.7
             */
            return navigator.sendBeacon(ajaxUrl + "?action=" + actions.export + "&everest_backup_ajax_nonce=" + _nonce + "&t=" + t, JSON.stringify(data));
        };
        /**
