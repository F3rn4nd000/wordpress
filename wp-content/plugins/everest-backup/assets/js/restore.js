...
(function () {
    ...
    var setMessage = function (message) {
        ...
        messageBox.innerHTML = "<p><strong>" + message + "</strong></p>";
    }; // setMessage.
    var lastDetail = '';
    var lastHash = '';
    ...
    var removeProcStatFile = function () {
        ...
        return navigator.sendBeacon(ajaxUrl + "?action=everest_backup_process_status_unlink&everest_backup_ajax_nonce=" + _nonce);
    };
    /** @since 2.0.0 */
    var triggerSendBecon = function (data) {
         ...
         * @since 1.0.7
         */
        return navigator.sendBeacon(ajaxUrl + "?action=" + actions.import + "&everest_backup_ajax_nonce=" + _nonce + "&t=" + t, JSON.stringify(data));
    };
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        result.then(function (res) {
                            ...
                            handleProcessDetails("Waiting for response. Retrying: " + retry);
    ...
    var Restore = function () {
        ...
        var onClickSaveBtn = function (data) {
            FileUploadedRes = {};
            navigator.sendBeacon(ajaxUrl + "?action=" + actions.saveUploadedPackage + "&everest_backup_ajax_nonce=" + _nonce, JSON.stringify(data));
            handleProgressInfo('', 0);
        ...
        var onClickCancelBtn = function (data) {
            document.title = prevTitleString;
            navigator.sendBeacon(ajaxUrl + "?action=" + actions.removeUploadedPackage + "&everest_backup_ajax_nonce=" + _nonce, JSON.stringify(data));
            handleProgressInfo('', 0);
            document.body.classList.remove(bodyClass);
            btnWrapper.classList.add('hidden');
        };
