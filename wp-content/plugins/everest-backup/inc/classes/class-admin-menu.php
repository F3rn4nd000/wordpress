...
class Admin_Menu {
	...
	public static function init() {
		add_filter( 'admin_head', '\Everest_Backup\Admin_Menu::upsell_attr', 10 );
		add_filter( 'clean_url', '\Everest_Backup\Admin_Menu::modify_menu_url', 10 );
	...
	protected static function get_submenus( $admin_bar = false ) {
		...
		if ( ! self::is_pro_installed() ) {
			...
			$submenus['upgradetopro'] = array(
				...
				'menu_title'  => '<strong class="everest-backup-upgradetopro" style="color:#ffffff;">' . __( "UPGRADE TO PRO", 'everest-backup' ) . '</strong>',
				'capability'  => 'manage_options',
